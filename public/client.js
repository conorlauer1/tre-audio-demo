...
var btnGoAudio = document.getElementById('goAudio');
...
window.onerror = function (err) {
  document.getElementById('error').innerHTML = JSON.stringify(arguments);
};
btnGoAudio.onclick = () => initiateCall();
